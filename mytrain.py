...
def train():
    ...
    print('-'*50)
    # save model
    json_string = model_systole.to_json()
    open('model_systole_architect.json','w').write(json_string)
    json_string = model_diastole.to_json()
    open('model_diastole_architect.json','w').write(json_string)
